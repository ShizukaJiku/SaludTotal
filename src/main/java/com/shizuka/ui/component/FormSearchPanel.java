...
import com.shizuka.ui.system.FormSearch;
...
public class FormSearchPanel extends JPanel {
    ...
    private void init() {
        ...
        textSearch.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Buscar...");
        textSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON, new FlatSVGIcon("app/icons/search.svg", 0.4f));
    ...
    private void showRecentResult() {
        ...
        if (recentSearch != null && recentSearch.length > 0) {
            ...
            if (!listItems.isEmpty()) {
                panelResult.add(createLabel("Reciente"), 0);
            }
        }
    ...
    private Component createNoResult(String text) {
        ...
        JLabel label = new JLabel("Sin resultados para \"");
    ...
    private class Item extends JButton {
        ...
        protected Component createRecentOption() {
            ...
            if (!isFavorite) {
                ...
                JLabel label = new JLabel(new SVGIconUIColor("app/icons/favorite_filled.svg", 0.4f, "Component.accentColor", 0.8f));
                label.putClientProperty(FlatClientProperties.STYLE, "" +
                        "border:3,3,3,3;");
                panel.add(label);
            }
        ...
        private JButton createButton(String name, String icon, float scale, String hoverKey, float alpha) {
            SVGIconUIColor svgIcon = new SVGIconUIColor("app/icons/" + icon, scale, "Label.disabledForeground", alpha);
