...
public class ThemesManager {
    ...
    void loadThemes() {
        ...
        try (Reader reader = new InputStreamReader(Objects.requireNonNull(getClass().getResourceAsStream("themes.json")), StandardCharsets.UTF_8)) {
