...
import com.shizuka.ui.component.FormSearchButton;
import com.shizuka.ui.component.MemoryBar;
import com.shizuka.ui.component.RefreshLine;
import com.shizuka.ui.icons.SVGIconUIColor;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JButton buttonDrawer = new JButton(new FlatSVGIcon("app/icons/menu.svg", 0.5f));
        buttonUndo = new JButton(new FlatSVGIcon("app/icons/undo.svg", 0.5f));
        buttonRedo = new JButton(new FlatSVGIcon("app/icons/redo.svg", 0.5f));
        buttonRefresh = new JButton(new FlatSVGIcon("app/icons/refresh.svg", 0.5f));
    ...
    private JPanel createFooter() {
        ...
        // demo version
        JLabel lbDemoVersion = new JLabel("App: v" + App.APP_VERSION);
        lbDemoVersion.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbDemoVersion.setIcon(new SVGIconUIColor("app/icons/git.svg", 1f, "Label.disabledForeground"));
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbJava.setIcon(new SVGIconUIColor("app/icons/java.svg", 1f, "Label.disabledForeground"));
        panel.add(lbJava);
