...
import com.shizuka.ui.component.AccentColorIcon;
import com.shizuka.ui.system.Form;
import com.shizuka.ui.system.FormManager;
import com.shizuka.ui.themes.PanelThemes;
...
public class FormSetting extends Form {
    ...
    protected void init() {
        ...
        accentColorButtons = new JToggleButton[accentColorKeys.length];
    ...
    private JToggleButton[] accentColorButtons;
